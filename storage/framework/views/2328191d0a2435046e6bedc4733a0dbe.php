            ...
            <div class="col-md-9">
                ...
                <div class="d-flex justify-content-center mb-3">
                    <?php for($i = 1; $i <= $pages; $i++): ?>
                        <a href="<?php echo e(url()->current()); ?>?page=<?php echo e($i); ?>" class="btn mx-1 <?php echo e($i == $page ? 'btn-dark' : 'btn-light'); ?>"><?php echo e($i); ?></a>
                    <?php endfor; ?>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mps-main\resources\views/dashboard.blade.php ENDPATH**/ ?>