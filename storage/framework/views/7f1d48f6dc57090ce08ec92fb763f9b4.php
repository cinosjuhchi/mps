<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Program | Komponen Pengurusan dan Pentadbiran'); ?>
    ...
    <div class="row">
        <div class="col">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18 text-capitalize">Program dan Aktiviti Tahunan - Pengurusan dan Pentadbiran
                </h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">Pengurusan Komponen</li>
                        <li class="breadcrumb-item">Pengurusan dan Pentabiran</li>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>12/10/2022</td>
                        <td>12/11/2022</td>
                        <td>JP Perancangan Strategik</td>
                        <td>
                            <span class="text-success bg-success bg-opacity-10 py-1 px-2 rounded">Selesai</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>12/10/2022</td>
                        <td>12/11/2022</td>
                        <td>JP Program Kecemerlangan</td>
                        <td>
                            <span class="text-danger bg-danger bg-opacity-10 py-1 px-2 rounded">Gagal</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editProgram">
                    ...
                    <tr>
                        ...
                        <td>12/10/2022</td>
                        <td>12/11/2022</td>
                        <td>JP Penyelengaraan Fizikal</td>
                        <td>
                            <span class="text-warning bg-warning bg-opacity-10 py-1 px-2 rounded">Belum Selesai</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editProgram">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/program-pengurusan-dan-pentadbiran.blade.php ENDPATH**/ ?>