...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Minda Pengetua'); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php if(Auth::user()->jawatan_app != 6): ?>
                                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                        <a href="#" class="btn btn-primary d-flex align-items-center justify-content-center"><i class="bx bx-plus me-1"></i> Tambah
                                            Minda</a>
                                    </div>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\mpsOnline\mps\resources\views/minda-pengetua.blade.php ENDPATH**/ ?>