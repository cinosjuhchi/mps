<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('Akaun-user'); ?> <?php $__env->stopSection(); ?>
                    ...
                    <form autocomplete="off" class="needs-validation createContact-form" id="createContact-form" novalidate>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    <label for="nama_sekolah-input" class="form-label">Nama Sekolah</label>
                                    <input type="text" id="nama_sekolah-input" class="form-control"
                            ...
                            <div class="col-lg-12">
                                <div class="text-end">
                                    ...
                                    <button type="submit" id="addContact-btn" class="btn btn-primary">Add
                                        Customer</button>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php if(Auth::check() && (Auth::user()->jawatan_app == 0 || Auth::user()->jawatan_app == 1)): ?>
        <script src="<?php echo e(URL::asset('build/js/pages/akaun-user-list.init.js')); ?>"></script>
    <?php else: ?>
        <script src="<?php echo e(URL::asset('build/js/pages/contact-user-list.init.js')); ?>"></script>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/akaun-user.blade.php ENDPATH**/ ?>