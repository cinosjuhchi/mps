...
<?php $__env->startSection('content'); ?>
                ...
                <div class="modal-body">
                    <div class="card border text-center p-0 mx-auto" style="width: 14rem">
                        <div class="card-body p-0 shadow-none">
                            ...
                            <p class="text-muted mb-2 font-size-14">Pekerja Kantin</p>
                        </div>
    ...
    <div class="modal fade" id="tambahGuru" tabindex="-1" aria-labelledby="tambahGuruLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="tambahGuruLabel">Tambah Pekerja Kantin</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="">
                    <div class="modal-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/senarai-pekerja-kantin.blade.php ENDPATH**/ ?>