<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('Citra Guru Besar'); ?> <?php $__env->stopSection(); ?>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18 text-capitalize">Citra Guru Besar</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Citra Guru Besar</li>
                </ol>
            </div>
...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h5 class="card-title">Citra Guru Besar <span class="text-muted fw-normal ms-2">(535)</span></h5>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-4 col-sm-6">
        <div class="card border shadow-none">
            <div class="">
                <img src="<?php echo e(asset('images/img1.jpg')); ?>" alt="" class="img-fluid">
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/citra-guru-besar.blade.php ENDPATH**/ ?>