<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Carta Organisasi Pengurusan Komponen'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(Auth::user()->jawatan_app != 6 and Auth::user()->jawatan_app != 1): ?>
        <button type="button" class="btn btn-primary tambah-cops mb-3" data-bs-toggle="modal" data-bs-target="#tambahGuru">
            <i class='bx bx-plus'></i> Tambah Guru</button>
    ...
    <div class="card border rounded shadow-sm border border-dark border-opacity-25 pb-2">
        ...
        <div class="card-body">
                                    ...
                                    <td>
                                        <?php if(Auth::user()->jawatan_app == 7): ?>
                                            <button class="btn btn-warning ms-auto" data-bs-toggle="modal"
                                                data-bs-target="#kemaskiniKomponen"><i class='bx bxs-edit'></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <?php if(Auth::user()->jawatan_app == 7): ?>
                                            <button class="btn btn-warning ms-auto" data-bs-toggle="modal"
                                                data-bs-target="#kemaskiniKomponen2"><i class='bx bxs-edit'></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <?php if(Auth::user()->jawatan_app == 7): ?>
                                            <button class="btn btn-warning ms-auto" data-bs-toggle="modal"
                                                data-bs-target="#kemaskiniKomponen3"><i class='bx bxs-edit'></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <?php if(Auth::user()->jawatan_app == 7): ?>
                                            <button class="btn btn-warning ms-auto" data-bs-toggle="modal"
                                                data-bs-target="#kemaskiniKomponen4"><i class='bx bxs-edit'></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="d-none" style="width:100%; height: 80vh;" id="tree">
                ...
                <div class="modal modal-lg fade mt-5" id="kemaskiniKomponen" tabindex="-1"
                            aria-labelledby="kemaskiniKomponenLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="kemaskiniKomponenLabel">Kemaskini</h1>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <table class="table table-borderless">
                                                <thead>
                                                    <tr>
                                                        <th class="text-bg-warning text-center rounded" colspan="3">Kemaskini
                                                            Komponen
                                                            Penguasa dan
                                                            Pentadbiran</th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value=" Marina binti Idris"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Syarifah binti Syed"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Mazniyah binti Zainudin"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Farizul bin Nor Yacoob"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Fauziah binti Ismail"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Abdullah bin Zaawi"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Rahimi bin Saufi"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Norazidi bin Che Amat"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Lee Hock Chan"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Razuki bin Rauf"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                </tbody>
                ...
                <div class="modal modal-lg fade mt-5" id="kemaskiniKomponen2" tabindex="-1"
                            aria-labelledby="kemaskiniKomponen2Label" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="kemaskiniKomponen2Label">Kemaskini</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Maliki bin Ayub"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Suzana binti Muhammad"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                ...
                <div class="modal modal-lg fade mt-5" id="kemaskiniKomponen3" tabindex="-1"
                            aria-labelledby="kemaskiniKomponen3Label" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="kemaskiniKomponen3Label">Kemaskini</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>:</th>
                                                        <td>
                                                            <input type="text" name="" value="Meor Ayubi bin Ali"
                                                                id="" class="form-control">
                                                        </td>
                                                    </tr>
                                                    <tr>
                ...
                <div class="modal modal-lg fade" id="kemaskiniKomponen4" tabindex="-1"
                            aria-labelledby="kemaskiniKomponen4Label" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="kemaskiniKomponen4Label">Kemaskini</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/copk.blade.php ENDPATH**/ ?>