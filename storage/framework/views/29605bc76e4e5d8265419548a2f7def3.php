...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(Auth::user()->jawatan_app != 6 and Auth::user()->jawatan_app != 1): ?>
        <button type="button" class="btn btn-primary tambah-cops mb-3" data-bs-toggle="modal" data-bs-target="#tambahGuru"><i class='bx bx-plus'></i> Tambah Guru</button>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th class="text-bg-primary text-center rounded" colspan="3">Komponen Penguasa dan Pentadbiran</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th class="text-bg-success text-center rounded" colspan="3">Komponen Hal Ehwal Murid</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th class="text-bg-warning text-center rounded" colspan="3">Komponen KoKurikulum</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
