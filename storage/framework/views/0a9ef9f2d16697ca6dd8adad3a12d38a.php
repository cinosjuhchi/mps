<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('Detail Minda/ Guru Besar'); ?> <?php $__env->stopSection(); ?>
        ...
        <div class="card border">
            <div class="card-body">
                <div class="">
                    ...
                    <div class="mb-4">
                        <img src="<?php echo e(asset('images/1641266225.jpg')); ?>" alt="" class="img-thumbnail mx-auto d-block">
                    </div>
                        ...
                        <div class="list-group list-group-flush">
                            <a href="javascript: void(0);" class="list-group-item text-muted pb-3 pt-0 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="<?php echo e(asset('images/img1.jpg')); ?>" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-13 text-truncate">Selangkah, Sederap kita bersama</h5>
                                        <p class="mb-0 text-truncate">5 Januari 2023 <span class="">/ 05:00 AM</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-truncate">12 Desember 2022 <span class="">/ 05:05 AM</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-truncate">10 Oktober 2022 <span class="">/ 05:10 PM</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-truncate">12 Ogos 2022 <span class="">/ 05:30 PM</span></p>
                                    </div>
                                </div>
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/detail-minda.blade.php ENDPATH**/ ?>