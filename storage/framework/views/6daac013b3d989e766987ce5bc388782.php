<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('Akaun-BackOfiice'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('li_1'); ?> Backoffice <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Akaun <?php $__env->endSlot(); ?>
                        ...
                        <div class="text-sm-end">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#newContactModal"
                                class="btn btn-primary waves-effect waves-light addContact-modal mb-2"><i
                                    class="mdi mdi-plus me-1"></i>Buat Pengguna Baharu</button>
                        </div>
                    </div><!--   end col-->
                </div>
                <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jawatan" id="jawatanApp" class="form-select">
                                        ...
                                        <option value="super_admin">Super Admin BackOffice</option>
                            ...
                            <div class="col-lg-12">
                                <div class="text-end">
                                    ...
                                    <button type="submit" id="addContact-btn" class="btn btn-primary">Tambah Pengguna</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php if(Auth::check() && (Auth::user()->jawatan_app == 0 || Auth::user()->jawatan_app == 1)): ?>
        <script src="<?php echo e(URL::asset('build/js/pages/akaun-backoffice-list.init.js')); ?>"></script>
    <?php else: ?>
        <script src="<?php echo e(URL::asset('build/js/pages/contact-user-list.init.js')); ?>"></script>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/akaun-backoffice.blade.php ENDPATH**/ ?>