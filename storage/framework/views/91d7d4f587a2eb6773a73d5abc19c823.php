<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Logo JPN'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <img src="<?php echo e(asset('images/kementerian_pendidikan_malaysia.png')); ?>" alt="" srcset=""class="img-fluid d-block m-auto"
        style="width:12rem;">
    <?php if(Auth::user()->jawatan_app != 6): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/logo-jpn.blade.php ENDPATH**/ ?>