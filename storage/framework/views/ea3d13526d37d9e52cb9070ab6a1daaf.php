<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Bilik Darjah'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="mb-3">
                            <?php if(Auth::user()->jawatan_app == 2 || Auth::user()->kategori_sekolah == "sekolah_rendah"): ?>
                            ...
                            <?php if(Auth::user()->jawatan_app == 3 || Auth::user()->kategori_sekolah == "sekolah_menengah"): ?>
    ...
    <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered text-dark">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editLabel">Edit Bilik Darjah</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary">Edit Bilik Darjah</button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5788632/public_html/mpsonline.oqurystudio.com/resources/views/bilik-darjah.blade.php ENDPATH**/ ?>