...
@section('title') @lang('Akaun-user') @endsection
...
@section('script')
    ...
    @if(Auth::check() && (Auth::user()->jawatan_app == 0 || Auth::user()->jawatan_app == 1))
        <script src="{{ URL::asset('build/js/pages/akaun-user-list.init.js') }}"></script>
    @else
