        ...
        <div class="card shadow-none">
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-center mb-3">
                    <div class="d-flex">
                        <img src="{{ asset('images/avatar-1.jpg') }}" alt="Profilku" width="100" height="100" class="rounded-circle">
                        <div class="d-flex flex-column justify-content-center ms-4">
                            ...
                            <p class="card-title-desc">
                                ...
                                @elseif (Auth::user()->jawatan_app == 1)
                                Admin Backofice
                                @elseif (Auth::user()->jawatan_app == 2)
                                Admin Sekolah
                                @else
                                Pengguna
                                @endif
                ...
                <div class="tab-content p-3 pt-5 text-muted">
                    <div class="tab-pane active" id="profilku" role="tabpanel">
                        <form action="">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" value="{{ Auth::user()->name }}" id="nama" disabled>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-select" id="jawatan-sekolah" disabled>
                                        <option @if(Auth::user()->jawatan_sekolah == "Guru Besar") selected @endif>Guru Besar</option>
                                        <option @if(Auth::user()->jawatan_sekolah == "Guru Penolong Kanan") selected @endif>Guru Penolong Kanan</option>
                                        <option @if(Auth::user()->jawatan_sekolah == "Guru Akademik") selected @endif>Guru Akademik</option>
                                        <option @if(Auth::user()->jawatan_sekolah == "Staf") selected @endif>Staf</option>
                                        <option @if(Auth::user()->jawatan_sekolah == "Parent") selected @endif>Parent</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-select" id="jawatan-sekolah" disabled>
                                        <option @if(Auth::user()->jawatan_app == 0) selected @endif>Super Admin</option>
                                        <option @if(Auth::user()->jawatan_app == 1) selected @endif>Admin Backofice</option>
                                        <option @if(Auth::user()->jawatan_app == 2) selected @endif>Admin Sekolah</option>
                                        <option @if(Auth::user()->jawatan_app == 3) selected @endif>Pengguna</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" placeholder="Masukkan nombor telefon" id="no-telepon" value="{{Auth::user()->telp}}">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="e-mel" class="col-sm-2 col-form-label">E-mel</label>
                                <div class="col-sm-5">
                                    <input type="email" class="form-control" placeholder="Masukkan emel" id="e-mel" value="{{Auth::user()->email}}">
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="surat-aku-janji" role="tabpanel">
                        <div class="text-center mb-3">
                            <img src="{{ asset('images/logo-jata-negara.png')}}" alt="Logo Jata Negara" width="150px" class="pb-2"><br>
