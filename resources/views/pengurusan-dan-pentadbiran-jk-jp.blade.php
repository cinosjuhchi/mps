            ...
            if (id == "tree-jr1") {
                chart.load([{
                    ...
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/GPK-Hal-Ehwal-Murid.png') }}",
                        telefon: "019-7421 220",
                        emel: "rahimi.saufi@moe.gov.my"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/GPK-KoKurikulum.png') }}"
                    },
                    {
                        id: 5,
                        pid: 3,
                        peranan: "JP Program Kecemerlangan",
                        img: "{{ asset('images/foto_guru/GPK-Pendidikan-Khas.png') }}"
                    },
                    {
                        id: 6,
                        pid: 3,
                    ...
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/Guru-Bimbingan.png') }}",
                        telefon: "019-7421 220",
                        emel: "rahimi.saufi@moe.gov.my"
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/Guru-Penyelaras-Bestari.png') }}",
                        telefon: "019-7421 220",
                        emel: "rahimi.saufi@moe.gov.my"
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/Guru-Perpustakaan-dan-Media.png') }}",
                        telefon: "019-7421 220",
                        emel: "rahimi.saufi@moe.gov.my"
                    },
                    {
                        ...
                        img: "{{ asset('images/foto_guru/Guru-Data.png') }}",
                        telefon: "019-7421 220",
                        emel: "rahimi.saufi@moe.gov.my"
                    },
                    {
