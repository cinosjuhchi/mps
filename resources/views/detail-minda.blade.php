...
@section('title') @lang('Detail Minda/ Guru Besar') @endsection
        ...
        <div class="card border">
            <div class="card-body">
                <div class="">
                    ...
                    <div class="mb-4">
                        <img src="{{asset('images/1641266225.jpg')}}" alt="" class="img-thumbnail mx-auto d-block">
                    </div>
                        ...
                        <div class="list-group list-group-flush">
                            <a href="javascript: void(0);" class="list-group-item text-muted pb-3 pt-0 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="{{asset('images/img1.jpg')}}" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
